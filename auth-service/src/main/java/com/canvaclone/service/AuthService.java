...
import com.canvaclone.client.NotificationClient;
...
public class AuthService {
    ...
    public AuthDto.AuthResponse register(AuthDto.RegisterRequest request) {
        ...
        // Send asynchronously/remotely using Feign client
        try {
            notificationClient.sendVerificationEmail(savedUser.getEmail(), verificationToken);
        } catch (Exception e) {
    ...
    public AuthDto.ApiResponse forgotPassword(AuthDto.ForgotPasswordRequest request) {
        ...
        try {
            notificationClient.sendOtpEmail(user.getEmail(), otp);
        } catch (Exception e) {
